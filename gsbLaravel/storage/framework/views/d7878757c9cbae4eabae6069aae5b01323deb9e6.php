...
<form method = "post" action = "">
       ...
       <a href="<?php echo e(route('chemin_modifierMDP')); ?>">Mot De Passe Oublié</a>
        </p>
       
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('modeles/visiteur', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\Missions\AP\E5\gsbLaravel\resources\views/connexion.blade.php ENDPATH**/ ?>