...
<form method = "post" action = "">
       ...
       <input type = "reset" value = "Annuler" name = "annuler"> 
        ...
        <p>
            <a href="<?php echo e(route('chemin_connexionCompta')); ?>" title="connexion comptable ">Connecter en tant que visiteur</a>
        </p>
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('modeles/visiteur', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Mission2-b\laragon+\www\gsbLaravel\resources\views/connexionCompta.blade.php ENDPATH**/ ?>