<!--@extends ('sommaireCompta')
    ...
    <table class="table">
        ...
        <h1>le nombre de visiteur est : {{count($les_visiteurs)}} </h1>
         
        <tbody>
        <//?php
       
        //foreach($les_visiteurs as $levisiteur) 
        {
        ?>
        <tr>
            <td> <//?php echo $levisiteur['id']; ?> </td>
            <td> <//?php echo $levisiteur['nom']; ?> </td>
            <td> <//?php echo $levisiteur['prenom']; ?> </td>
            <td> <//?php echo $levisiteur['login']; ?> </td>
            <td> <//?php echo $levisiteur['mdp']; ?> </td>
            <td> <//?php echo $levisiteur['adresse']; ?> </td>
            <td> <//?php echo $levisiteur['cp']; ?> </td>
            <td> <//?php echo $levisiteur['ville']; ?> </td>
            <td> <//?php echo $levisiteur['dateEmbauche']; ?> </td>
